...
protected:
	...
	virtual CExtSafeString TextGetValid() const;
	virtual bool _DeleteSymbols( CExtSafeString & strText, INT & nStart, INT & nEnd, bool bBackspace = false ) = 0;
	...
	CExtSafeString m_strNegativeSign, m_strCurrencySymbol, m_strDecimalPoint, m_strGroupSeparator;
...
protected:
	...
	virtual bool _DeleteSymbols( CExtSafeString & strText, INT & nStart, INT & nEnd, bool bBackspace = false );
