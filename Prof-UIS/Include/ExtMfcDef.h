...
#define __PROF_UIS_VERSION_DWORD    DWORD( 0x02080700 )
#define __PROF_UIS_VERSION                 0x02080700
...
#if ( (defined _AFXDLL) || ( _MFC_VER >= 0x1000 ) )
...
// Prof-UIS basic library
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ymd-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ynd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yu-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ym-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yn-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ymd.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ynd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yu.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ym.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287yn.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		...
		#define __PROF_UIS_STATE_MANAGER_DECL _declspec(dllimport)
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287ud-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287md-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287md-RDE.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287nd-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287nd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287u-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287u-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287m-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287m-RDE.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287n-RDE.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287n-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287ud.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287ud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287md.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287md.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287nd.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287nd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287u.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287u.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287m.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287m.lib"
				#else
					#define __PROF_UIS_MODULE_NAME	_T("ProfUIS287n.dll")
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287n.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#endif // else from (defined __PROF_UIS_FOR_REGULAR_DLL)
			...
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sud-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287smd-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287snd-RDE.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287su-RDE.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sm-RDE.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sn-RDE.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#else
			#define __PROF_UIS_MANAGE_STATE AFX_MANAGE_STATE( ::AfxGetAppModuleState() )
			#if (defined _DEBUG)
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sud.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287smd.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287snd.lib"
				#endif // _UNICODE
			#else
				#if (defined _UNICODE)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287su.lib"
				#elif (defined _MBCS)
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sm.lib"
				#else
					#define __PROF_UIS_LIB_NAME		   "ProfUIS287sn.lib"
				#endif // _UNICODE
			#endif // _DEBUG
		#endif // else from (defined __PROF_UIS_FOR_REGULAR_DLL)
#endif // _AFXDLL
