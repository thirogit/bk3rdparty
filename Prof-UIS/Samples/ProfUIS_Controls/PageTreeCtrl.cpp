...
TV_DISPINFO * pTVDispInfo = (TV_DISPINFO*)pNMHDR;
	...
	{
		CString str;
		str.Format( _T("Item 0x%08X with externally queried text"), pTVDispInfo->item.hItem );
		__EXT_MFC_STRNCPY( pTVDispInfo->item.pszText, pTVDispInfo->item.cchTextMax, LPCTSTR(str), str.GetLength() );
	}
	*pResult = 0;
}
