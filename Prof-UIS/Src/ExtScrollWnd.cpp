...
LRESULT lResult =
		CScrollBar::WindowProc( message, wParam, lParam );
...
void CExtScrollWnd::OnDisplayChange(UINT nImageDepth, int cxScreen, int cyScreen)
{
	CWnd::OnDisplayChange( nImageDepth,  cxScreen, cyScreen);
//CExtPaintManager * pPM = PmBridge_GetPM();
