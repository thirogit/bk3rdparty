...
void CExtStatusControlBar::OnDisplayChange(UINT nImageDepth, int cxScreen, int cyScreen)
{
	ASSERT_VALID( this );
	CStatusBar::OnDisplayChange(nImageDepth, cxScreen, cyScreen);
	CExtPaintManager * pPM = PmBridge_GetPM();
	g_PaintManager.OnDisplayChange(this, nImageDepth, CPoint(cxScreen, cyScreen));
	g_CmdManager.OnDisplayChange(pPM, this, nImageDepth, CPoint(cxScreen, cyScreen));
