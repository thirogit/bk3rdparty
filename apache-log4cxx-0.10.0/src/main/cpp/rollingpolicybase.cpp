...
RollingPolicyBase::RollingPolicyBase(RollingPolicyBase && o) : helpers::ObjectImpl(std::move(o))
	,patternConverters(std::move(o.patternConverters))
	,patternFields(std::move(o.patternFields))
	,fileNamePatternStr(o.fileNamePatternStr)
{	
}

RollingPolicyBase& RollingPolicyBase::operator=(RollingPolicyBase && o)
{
