...
#include "casajson/asyncrt_utils.h"
...
public:
        ...
        /// <returns>A JSON array value</returns>
        static _ASYNCRTIMP json::value __cdecl array(const std::vector<value>& elements);


		/// <summary>
		/// Creates a single element JSON array
		/// </summary>
		/// <param name="element">A JSON value</param>
		/// <returns>A JSON array value</returns>
		static _ASYNCRTIMP json::value __cdecl array(value element);
		static _ASYNCRTIMP json::value __cdecl array(value e1, value e2);
		static _ASYNCRTIMP json::value __cdecl array(value e1, value e2, value e3);
		static _ASYNCRTIMP json::value __cdecl array(value e1, value e2, value e3, value e4);
		static _ASYNCRTIMP json::value __cdecl array(value e1, value e2, value e3, value e4, value e5);
        ...
        /// </summary>
        /// <returns>A string representation of the value</returns>
        CASABLANCA_DEPRECATED("This API is deprecated and has been renamed to avoid confusion with as_string(), use ::json::value::serialize() instead.")
...
public:
    ...
    public:
        json_exception() {}
        json_exception(const utility::char_t * const &message) : _message(utility::conversions::to_utf8string(message)), _wmessage(message) { }
		...
		const wchar_t* wwhat() const CPPREST_NOEXCEPT
		{
			return _wmessage.c_str();
		}
    ...
    public:
        ...
        json::value& at(const utility::string_t& key)
        {
            ...
            if (iter == m_elements.end() || key != (iter->first))
                throw json::json_exception(_XPLATSTR("Key not found"));
...
#ifdef _UTF16_STRINGS
            virtual void l(std::wstring& str) const
            {
                serialize_impl_char_type(str);
            }
#endif
