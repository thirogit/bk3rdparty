 ...
 * @tprm C... : char_type non-type parameter pack whose ordered sequence results
...
private:
    static constexpr char_type const   vals[sizeof...(C)+1] = { C...,'\0' };
...
template<char_type... C>
constexpr char_type const typestring<C...>::vals[sizeof...(C)+1];
...
constexpr char_type tygrab(char_type const(&c)[M]) noexcept
{ return c[N < M ? N : M-1]; }
...
template<char_type... X>
auto typoke(typestring<X...>) // as is...
  -> typestring<X...>;

template<char_type... X, char_type... Y>
auto typoke(typestring<X...>, typestring<'\0'>, typestring<Y>...)
  -> typestring<X...>;

template<char_type A, char_type... X, char_type... Y>
...
template<char_type... A, char_type... B, typename... X>
